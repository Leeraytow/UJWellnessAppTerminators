...
export default function StudentAuthScreen({ navigation }) {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      navigation.navigate('RegEmailVerification', { userEmail: email, userName: fullName, uid: user.uid });
    } catch (error) {
      setError(error.message);
    } finally {
      setLoading(false);
        ...
        <View style={styles.authContainer}>
          ...
          <View style={styles.socialButtonsContainer}>
            <TouchableOpacity style={styles.socialButton}>
              <Image source={require('../images/google.jpeg')} style={styles.socialIcon} />
              <Text style={styles.socialButtonText}>Google</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.socialButton}>
              <Image source={require('../images/facebook.jpeg')} style={styles.socialIcon} />
